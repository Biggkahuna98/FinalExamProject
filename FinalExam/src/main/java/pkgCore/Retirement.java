...
public class Retirement {
	...
	public double MonthlySavings() {
		...
		double pmt = PMT(this.dAnnualReturnWorking / 12, this.iYearsToWork * 12, 0, TotalAmountToSave(), false); // <-- this should be fixed to calculate the real pmt
		return Math.round(Math.abs(pmt) * 100.0) / 100.0;
	}
